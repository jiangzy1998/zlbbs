...
class AddBannerForm(BaseForm):
    ...
    image_url = StringField(validators=[InputRequired(message="请输入轮播图片连接！")])
    link_url = StringField(validators=[InputRequired(message="请输入轮播图片跳转连接！")])
...
class AddBoardForm(BaseForm):
    name = StringField(validators=[InputRequired(message='请输入模块名称！')])
